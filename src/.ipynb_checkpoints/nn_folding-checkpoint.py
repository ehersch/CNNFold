...
from folding_algorithms import NussinovAlgorithm, ZukerAlgorithm, OptimizedNussinovAlgorithm, OptimizedNussinovWithFourRussians
...
class RNASecondaryStructurePredictor:
    ...
    def predict_structure(self, sequence):
        X_new = self._one_hot_encode(sequence, self.max_len)[None, ...] 
...
if __name__ == "__main__":
    ...
    predictor.model.save('rna_structure_model.h5')
